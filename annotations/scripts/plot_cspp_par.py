...
ims = [oi.CE01ISSP_PARAD,oi.CE02SHSP_PARAD,oi.CE06ISSP_PARAD,oi.CE07SHSP_PARAD]
...
def plot_data(df,variables,fdir,figname):
    ...
    df2 = oh.df_drop_range(df2,'par',0,17000)
    df2 = oh.df_drop_range(df2,'parad_j_par_counts_output',0,6500)   
    ...
    for i in range(len(vs)):            
        ...
        cax = fig.add_axes([0.91,ypos,0.01,0.245])
